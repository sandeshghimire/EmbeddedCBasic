...
/** @file
 * clearBits.c
 * This Exmaple shows how to toggle a bit on a unigned int 
 */
...
unsigned int toggle_bit(unsigned int value, unsigned char bit);
...
int main(int argc, char *argv)
{
    ...
    printf("vlaue after bit %X toggle is  is %X \n", bit, data);
    data = toggle_bit(data, bit);
    printf("vlaue after bit %X toggle is  is %X \n", bit, data);
...
/**
 * toggle a bit from a unigned int vlaue
 *
